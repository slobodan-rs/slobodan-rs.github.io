const SpaceX = {
    render: () => {
        ...
        <div class="discription">
            <h2>Space X</h2>
            <p>In this app you can search all of SpaceX launch vehicles. Developed with JavaScript DOM modules, using spacex API
                and Axios Promise based HTTP client</p>
